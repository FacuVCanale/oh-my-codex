...
The bounded diagnostics also represent `start-unavailable`, `exit-failure`, and `timeout`; unreviewed, malformed, or over-limit output yields `documented_root_identity.status:"unknown"`. No diagnostic combination authorizes.
